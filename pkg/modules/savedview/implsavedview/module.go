...
func (module *module) GetViewsForFilters(ctx context.Context, orgID string, sourcePage string, name string, category string) ([]*v3.SavedView, error) {
	...
	if err != nil {
		return nil, errors.Newf(errors.TypeInternal, errors.CodeInternal, "error in getting saved views: %s", err.Error())
	}
	...
	for _, view := range views {
		...
		if err != nil {
			return nil, errors.Newf(errors.TypeInternal, errors.CodeInternal, "error in unmarshalling explorer query data: %s", err.Error())
		}
...
func (module *module) CreateView(ctx context.Context, orgID string, view v3.SavedView) (valuer.UUID, error) {
	...
	if err != nil {
		return valuer.UUID{}, errors.Newf(errors.TypeInternal, errors.CodeInternal, "error in marshalling explorer query data: %s", err.Error())
	}
	...
	if errv2 != nil {
		return valuer.UUID{}, errors.New(errors.TypeUnauthenticated, errors.CodeUnauthenticated, "error in getting email from context")
	}
	...
	if err != nil {
		return valuer.UUID{}, errors.Newf(errors.TypeInternal, errors.CodeInternal, "error in creating saved view: %s", err.Error())
	}
	return uuid, nil
}
...
func (module *module) GetView(ctx context.Context, orgID string, uuid valuer.UUID) (*v3.SavedView, error) {
	...
	if err != nil {
		return nil, errors.Newf(errors.TypeInternal, errors.CodeInternal, "error in getting saved view: %s", err.Error())
	}
...
func (module *module) UpdateView(ctx context.Context, orgID string, uuid valuer.UUID, view v3.SavedView) error {
	data, err := json.Marshal(view.CompositeQuery)
	if err != nil {
		return errors.Newf(errors.TypeInternal, errors.CodeInternal, "error in marshalling explorer query data: %s", err.Error())
	}

	claims, errv2 := authtypes.ClaimsFromContext(ctx)
	if errv2 != nil {
		return errors.New(errors.TypeUnauthenticated, errors.CodeUnauthenticated, "error in getting email from context")
	}
	...
	_, err = module.sqlstore.BunDB().NewUpdate().
		...
		Exec(ctx)
	if err != nil {
		return errors.Newf(errors.TypeInternal, errors.CodeInternal, "error in updating saved view: %s", err.Error())
	}
	return nil
}
...
func (module *module) DeleteView(ctx context.Context, orgID string, uuid valuer.UUID) error {
	_, err := module.sqlstore.BunDB().NewDelete().
		...
		Exec(ctx)
	if err != nil {
		return errors.Newf(errors.TypeInternal, errors.CodeInternal, "error in deleting explorer query: %s", err.Error())
	}
	return nil
}
